...
parser.add_argument('--epoch_step', default=[800], type=int, nargs='+',
...
parser.add_argument('--resume', default='checkpoint/voc2007/checkpoint.pth.tar', type=str, metavar='PATH',
